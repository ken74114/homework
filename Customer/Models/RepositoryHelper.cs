namespace Customer.Models
{
	public static class RepositoryHelper
	{
		...
		public static v_rpt1Repository Getv_rpt1Repository()
		{
			var repository = new v_rpt1Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static v_rpt1Repository Getv_rpt1Repository(IUnitOfWork unitOfWork)
		{
			var repository = new v_rpt1Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
